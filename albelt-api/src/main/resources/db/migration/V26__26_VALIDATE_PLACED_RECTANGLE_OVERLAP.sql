...
CREATE OR REPLACE FUNCTION validate_placed_rectangle_overlap()
RETURNS TRIGGER AS $$
DECLARE
...
DO $$
BEGIN
    IF NOT EXISTS (SELECT 1 FROM information_schema.triggers WHERE trigger_name = 'trigger_placed_rectangle_overlap') THEN
