...
(
    ...
    commande_id UUID NOT NULL REFERENCES commandes
(
    id
) ON DELETE CASCADE,
...
(
    ...
    longueur_tolerance_m DECIMAL
(
    10,
    2
) DEFAULT 0,
    largeur_mm INTEGER NOT NULL CHECK
(
    largeur_mm >
    0
),
    ...
    -- Quantities
    quantite INTEGER NOT NULL DEFAULT 1 CHECK
(
    quantite >
    0
),
    surface_consommee_m2 DECIMAL
(
    12,
    4
) NOT NULL DEFAULT 0 CHECK
(
    surface_consommee_m2
    >=
    0
),
    waste_created_m2 DECIMAL
(
    12,
    4
) DEFAULT 0,
...
(
    ...
    last_roll_used_id UUID REFERENCES rolls
(
    id
)
  ON DELETE SET NULL,
