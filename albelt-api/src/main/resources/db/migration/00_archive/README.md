...
**Status:** These migrations have already been executed on the production database and will NOT be re-executed by Flyway (Flyway tracks migrations by version number).
...
Archive files are saved as-is for historical reference and troubleshooting. They demonstrate the evolution of the system during active development.
