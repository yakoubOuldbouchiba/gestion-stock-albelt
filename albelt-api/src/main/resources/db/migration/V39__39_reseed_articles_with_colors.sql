...
FROM (
         ...
         WHERE material_type IS NOT NULL) signature ON CONFLICT (material_type, thickness_mm, nb_plis, reference, coalesce(color_id, '00000000-0000-0000-0000-000000000000')) DO NOTHING;
