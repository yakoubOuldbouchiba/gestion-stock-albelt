...
VALUES
    ('Fournisseur PU Algérie', 'DZ', 'Mohamed Khaled', 'contact@fourni-pu.dz', '+213 21 123 456', 7, 'Main PU supplier'),
    ('Supplier PVC Europe', 'FR', 'Jean Dupont', 'sales@eu-pvc.fr', '+33 1 234 5678', 14, 'European PVC supplier'),
    ('Caoutchouc Direct', 'DZ', 'Karim Saidi', 'karim@caout.dz', '+213 23 987 654', 5, 'Natural rubber supplier')
...
SELECT * FROM (
    VALUES
    ('Entreprise ACME', 'Industrial manufacturing company', true),
    ('Al-Nassim Trading', 'Trading and distribution', true),
    ('Tech Solutions DZ', 'Technology and solutions provider', true)
...
SELECT
    'CMD-' || TO_CHAR(CURRENT_DATE, 'YYYYMMDD') || '-001',
...
INSERT INTO commande_items (
    commande_id, material_type, nb_plis, thickness_mm,
...
SELECT
    (SELECT id FROM commandes WHERE numero_commande LIKE 'CMD-%' LIMIT 1),
...
-- ============================================================================
SELECT 
    'Users' AS entity, COUNT(*) FROM users
UNION ALL
SELECT 'Suppliers', COUNT(*) FROM suppliers
UNION ALL
SELECT 'Altiers', COUNT(*) FROM altier
UNION ALL
...
UNION ALL
SELECT 'Commande Items', COUNT(*) FROM commande_items;
